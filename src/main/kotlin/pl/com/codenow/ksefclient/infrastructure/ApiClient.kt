package pl.com.codenow.ksefclient.infrastructure
...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    companion object {
        ...
        const val baseUrlKey = "pl.com.codenow.ksefclient.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            ...
            val tempFile = java.nio.file.Files.createTempFile("tmp.pl.com.codenow.ksefclient", null).toFile()
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        ...
        if (requestConfig.headers["SessionToken"].isNullOrEmpty()) {
            if (apiKey["SessionToken"] != null) {
                if (apiKeyPrefix["SessionToken"] != null) {
                    requestConfig.headers["SessionToken"] = apiKeyPrefix["SessionToken"]!! + " " + apiKey["SessionToken"]!!
                } else {
                    requestConfig.headers["SessionToken"] = apiKey["SessionToken"]!!
                }
            }
        }
    }
