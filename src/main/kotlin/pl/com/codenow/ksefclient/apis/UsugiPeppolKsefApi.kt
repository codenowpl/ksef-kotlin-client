...
class UsugiPeppolKsefApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun apiV2PeppolQueryGet(pageOffset: kotlin.Int? = null, pageSize: kotlin.Int? = null) : QueryPeppolProvidersResponse {
        val localVarResponse = apiV2PeppolQueryGetWithHttpInfo(pageOffset = pageOffset, pageSize = pageSize)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as QueryPeppolProvidersResponse
     ...
     * @param pageOffset Numer strony wyników. (optional)
     * @param pageSize Rozmiar strony wyników. (optional)
     * @return ApiResponse<QueryPeppolProvidersResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun apiV2PeppolQueryGetWithHttpInfo(pageOffset: kotlin.Int?, pageSize: kotlin.Int?) : ApiResponse<QueryPeppolProvidersResponse?> {
        val localVariableConfig = apiV2PeppolQueryGetRequestConfig(pageOffset = pageOffset, pageSize = pageSize)

        return request<Unit, QueryPeppolProvidersResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation apiV2PeppolQueryGet
     *
     * @param pageOffset Numer strony wyników. (optional)
     * @param pageSize Rozmiar strony wyników. (optional)
     * @return RequestConfig
     */
    fun apiV2PeppolQueryGetRequestConfig(pageOffset: kotlin.Int?, pageSize: kotlin.Int?) : RequestConfig<Unit> {
