...
class CertyfikatyKluczaPublicznegoKsefApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
     ...
     * @return kotlin.collections.List<PublicKeyCertificate>
    ...
    fun apiV2SecurityPublicKeyCertificatesGet() : kotlin.collections.List<PublicKeyCertificate> {
        val localVarResponse = apiV2SecurityPublicKeyCertificatesGetWithHttpInfo()

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<PublicKeyCertificate>
     ...
     * Pobranie certyfikatów
     * Zwraca informacje o kluczach publicznych używanych do szyfrowania danych przesyłanych do systemu KSeF.
     * @return ApiResponse<kotlin.collections.List<PublicKeyCertificate>?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun apiV2SecurityPublicKeyCertificatesGetWithHttpInfo() : ApiResponse<kotlin.collections.List<PublicKeyCertificate>?> {
        val localVariableConfig = apiV2SecurityPublicKeyCertificatesGetRequestConfig()

        return request<Unit, kotlin.collections.List<PublicKeyCertificate>>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation apiV2SecurityPublicKeyCertificatesGet
     *
     * @return RequestConfig
     */
    fun apiV2SecurityPublicKeyCertificatesGetRequestConfig() : RequestConfig<Unit> {
