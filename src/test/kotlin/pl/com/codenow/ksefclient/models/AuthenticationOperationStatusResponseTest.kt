...
class AuthenticationOperationStatusResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AuthenticationOperationStatusResponse
        //val modelInstance = AuthenticationOperationStatusResponse()
